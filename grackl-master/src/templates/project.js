...
export default ({ data }) => {
  const {
      Value_proposition, Participating_university_departments, Participating_university, Success_criteria,
      Project_Name, Description, Link, Total_project_budget, Funding_source, Lead_Department, City_strategic_outcomes,
      Contact_Name, Contact_email, Project_stage, Contact_Title, Primary_strategic_outcome, Secondary_strategic_outcome
  } = data.airtable.data;
